object Testing {
    ...
    private const val testArchCoreVersion = "2.1.0"
    const val testArchCore = "androidx.arch.core:core-testing:$testArchCoreVersion"

    private const val testDexmakerVersion = "2.28.3"
    const val testDexmaker = "com.linkedin.dexmaker:dexmaker-mockito:$testDexmakerVersion"
}
